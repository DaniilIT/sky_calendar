...
class HelpfulTest(APITestCase):
    ...
    def create_category(self):
        ...
        url_cat = reverse('category_create')
...
class CommentTest(HelpfulTest):
    ...
    def test_comment_get_list(self):
        _ = GoalComment.objects.create(text='comment_one', goal=self.goal, user=self.user)
    ...
    def test_comment_get_detail(self):
        ...
        url_detailed = reverse('comment_detail', kwargs={'pk': response_comment.data['id']})
