...
class BoardParticipantsSerializer(serializers.BaseSerializer):
...
class BoardSerializer(serializers.BaseSerializer):
...
class BoardListSerializer(serializers.BaseSerializer):
    class Meta:
        model: Board
        fields = '__all__'
